...
public class AuthorizeTripCommandImpl extends UserCommandBaseImpl {
    ...
    public Optional<Status> execute() {
        ...
        if (arguments.isEmpty()) {
            ...
            super.engine.outService.enqueueMessageForSending(author, " example: *auth cmdTV+", isWhisper());
        ...
        super.engine.outService.enqueueMessageForSending(author, " authorized trip: " + trip, isWhisper());
