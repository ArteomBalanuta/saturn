...
5. **Update help.** Add a short description to the correct `HelpUserCommandImpl` section and retain its literal `\\n` and `\u2009` formatting conventions, including runtime prefix examples.
